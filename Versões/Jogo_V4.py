...
tower_placement_active = False
tower_placement_position = None
# Game loop
while running:
    clock.tick(FPS)
    # checa eventos
    ...
    # Inicia a tela principal 
        ...
        game_screen.blit(tower_icon_image, (10, 10))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if tower_icon_rect.collidepoint(mouse_pos):
                    tower_placement_active = True    
        if tower_placement_active:
            mouse_pos = pygame.mouse.get_pos()
            tower_placement_position = (
                mouse_pos[0] // TAMANHO_QUADRADO * TAMANHO_QUADRADO,
                mouse_pos[1] // TAMANHO_QUADRADO * TAMANHO_QUADRADO,
            )   

        if tower_placement_position:
            game_screen.blit(tower_image, tower_placement_position)
