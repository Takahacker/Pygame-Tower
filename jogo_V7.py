...
#--------------------------------- Gera Tela TUTORIAL 1---------------------------------

game_screen_tutorial = pygame.display.set_mode((WIDTH, HEIGHT))
...
# Create towers
tower1 = Tower(tower_image, 10, 100)
tower2 = Tower(tower_image, 10, 100)
tower3 = Tower(tower_image, 10, 100)
